...
\begin{itemize}
    \item  \underline{\textbf{Kimura, Taichi}} and Morimitsu, Takahiro. The Role of Loss Aversion in Multi-Rater Subjective Performance Evaluations. Available at: \url{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5083726}.
    
    \item Morimitsu, Takahiro and \underline{\textbf{Kimura, Taichi}}. On The Use Of Calibration Committees In Subjective Performance Evaluation. Available at: \url{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4290250}.
    
    \item \underline{\textbf{Kimura, Taichi}} and Yutaro, Murakami. Conformity pressure and compensation contracts. Available at: \url{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4113994}.
\end{itemize}
...
\begin{itemize}
    \item 「Next Step Japan株式会社」2025（CVP分析）.
    \item 「部門別原価計算ノート」2024．
    \item 「標準原価計算ノート」2024．
    \item 「資本予算ノート」2024．
    \item 「差額原価収益分析ノート」2024．
    \item 「CVP分析ノート」2023．
    \item 「プラネットゴルフ」2023（ABC）．
    \item 「管理会計計算ノート」2021．
