...
%
% Based on Jason Blevins' CV template (LuaLaTeX migration)
...
% --- LuaTeX-ja: Japanese (Hiragino ProN, deluxe weights) ---
\usepackage[hiragino-pron,deluxe]{luatexja-preset}

% --- Western body font: Palatino (TeX Gyre Pagella) ---
\usepackage{fontspec}
...
\begin{itemize}
    \item 2026年5月: 48th Annual Congress of European Accounting Association (Rome, Italy) ``Performance targets as screening devices'' (with Hikaru Mitsuhashi).

    \item 2026年5月: 48th Annual Congress of European Accounting Association (Rome, Italy) ``Incentive design with biased reviewers and compensation committee'' (with Takahiro Morimitsu).

    \item 2026年2月: 第10回AEAJ Workshop（福井市地域交流プラザ）``Centralize or decentralize? Co-location with accounting precision and incentive power.''

    \item 2025年12月: 日本経済会計学会第6回秋季大会（中央大学） ``Designing calibration committees: Size, standards, and rater bias'' (with Takahiro Morimitsu)

    \item 2025年5月: 47th Annual Congress of European Accounting Association (Rome, Italy) ``The Role of Loss Aversion in Multi-Rater Subjective Performance Evaluations'' (with Takahiro Morimitsu)

    \item 2024年11月: 33rd Asian-Pacific Conference on International Accounting Issues (Vancouver, Canada) ``A calibration committee with a loss-averse agent'' (with Takahiro Morimitsu)

    \item 2024年8月:  第83回日本会計研究学会（早稲田大学） ``A calibration committee with a loss-averse agent'' (with Takahiro Morimitsu)

    \item 2023年10月: 32nd Asian-Pacific Conference on International Accounting Issues (Gold coast, Australia) ``On the use of calibration committees in subjective performance evaluation'' (with Takahiro Morimitsu)

    \item 2023年5月: 45th Annual Congress of European Accounting Association (Helsinki-Espoo, Finland) ``On the use of calibration committees in subjective performance evaluation'' (with Takahiro Morimitsu)
...
\subsection*{研究会報告（2023年度以降）}

\begin{itemize}
    \item 2025年11月: 第98回分析的会計研究会 (慶應義塾大学),  ``Designing calibration committees: Size, standards, and rater bias.''
    \item 2025年11月: Contract Theory Workshop (立命館大学), ``Designing calibration committees: Size, standards, and rater bias.''
    \item 2025年3月: 第18回 Applied Economics and Management Workshop (新潟大学), ``The role of loss aversion in multi-rater subjective performance evaluations.''
    \item 2024年11月: 第67回 Handai Accounting Research Seminar (大阪大学), ``The role of loss aversion in multi-rater subjective performance evaluations.''
    \item 2024年8月: 第97回分析的会計研究会 (大学コンソーシアム京都),  ``A calibration committee with a loss-averse agent.''
    \item 2023年5月: 第60回 Doshisha Experimental Accounting and Finance Research (オンライン), ``On the use of calibration committees in subjective performance evaluation.''
    \item 2023年3月: 第94回分析的会計研究会 (西南学院大学), ``On the use of calibration committees in subjective performance evaluation.''
\end{itemize}

\section*{研究助成}

\begin{itemize}
\item 「主観的業績評価におけるバイアスの発生メカニズムとその緩和策についての理論的研究」（24K05206）文部科学省: 科学研究費補助金（基盤研究(C)）．研究期間：2024年4月-2027年3月．代表者：木村太一．
...
\subsection*{作成ケース教材（公開ケースのみ）}

\begin{itemize}
    \item 「Next Step Japan株式会社」2025.
    \item 「プラネットゴルフ」2023．
    \item 「管理会計計算ノート」2021．
    \item 「綱島金属株式会社」2021．
    \item 「小机タイヤ株式会社」2021．
   \item 「原価計算の基礎知識」2020 （2024改訂）．
   \item 「三菱電機」2018（森光高大と共著）．
   \item 「JALの再建とアメーバ経営」2016（2023改訂）．
\end{itemize}
...
\begin{itemize}
    \item 編集委員，『原価計算研究』，2025年10月 -- 現在
    \item 特別研究官，防衛装備庁，2018年6月1日 -- 2020年3月31日
\end{itemize}

\subsection*{査読経験}
    \begin{itemize}
        \item 原価計算研究，現代ディスクロージャー研究，慶應経営論集
    \end{itemize}
